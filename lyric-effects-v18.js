/* v18 — tuned from reference video: lower entry, steady upward float, soft-charcoal fast exit. */
(() => {
'use strict';
if (window.__captionV18) return;
window.__captionV18 = true;
...
#caption-stage:after{content:'';position:absolute;inset:0;pointer-events:none;background:radial-gradient(circle at 50% 48%,transparent 28%,#00000024 74%,#00000050 100%);opacity:.7;mix-blend-mode:multiply}
.caption-light-sweep{position:absolute;top:-18%;left:-40%;width:34%;height:140%;background:linear-gradient(90deg,transparent,#d9fff41a 42%,#ffffff22 50%,#b9f8e915 58%,transparent);filter:blur(18px);transform:rotate(10deg);opacity:.12;animation:light-sweep 19s cubic-bezier(.42,0,.58,1) infinite;will-change:transform,opacity}
@keyframes light-sweep{0%{transform:translate3d(-8vw,0,0) rotate(10deg);opacity:0}14%{opacity:.08}50%{opacity:.15}86%{opacity:.07}100%{transform:translate3d(155vw,0,0) rotate(10deg);opacity:0}}
.caption-haze{position:absolute;left:50%;top:78%;width:82vw;height:28vh;transform:translate(-50%,-50%);background:radial-gradient(ellipse,#8bf5d70d,transparent 70%);filter:blur(24px);opacity:.55;animation:haze-drift 16s ease-in-out infinite alternate;will-change:transform}
@keyframes haze-drift{to{transform:translate(-48%,-55%) scale(1.06)}}
...
.caption-math{position:absolute;left:var(--x);top:112%;font:500 var(--s) / 1.2 "Cambria Math",Georgia,serif;color:#d7fff6;opacity:0;text-shadow:0 0 18px #73efd055,0 0 4px #ffffff12;white-space:nowrap;will-change:transform,opacity;filter:blur(var(--blur,.15px));animation:math-rise var(--d) linear var(--delay) infinite;transform-origin:center}
@keyframes math-rise{0%{opacity:0;transform:translate3d(0,10vh,0) rotate(var(--r)) scale(var(--scale,.92))}10%{opacity:calc(var(--alpha,.11) * .4)}24%{opacity:var(--alpha,.11)}72%{opacity:calc(var(--alpha,.11) * .88)}100%{opacity:0;transform:translate3d(var(--drift),-138vh,0) rotate(calc(var(--r) * -1)) scale(calc(var(--scale,.92) + .11))}}
...
.caption-card{position:absolute;top:78%;width:clamp(205px,21vw,260px);min-height:124px;max-height:34vh;will-change:transform,opacity,filter,top;transform:translate3d(0,-50%,0);contain:layout paint;filter:drop-shadow(0 14px 32px #0000003b);transition:none}
.caption-card.right{right:7vw}.caption-card.left{left:7vw}

.caption-card:before,.caption-card:after{content:'';position:absolute;inset:6px 8px;border-radius:8px;border:1px solid #ffffff1d;background:#dffff20e;z-index:-2;opacity:.45;transform:translate3d(0,7px,0) scale(.985);filter:blur(.1px)}
.caption-card:after{inset:10px 14px;opacity:.22;transform:translate3d(0,14px,0) scale(.97);z-index:-3}
.caption-ripple{position:absolute;left:50%;top:50%;width:40px;height:40px;border:1px solid #cffff28a;border-radius:8px;transform:translate(-50%,-50%) scale(.35);opacity:0;pointer-events:none;box-shadow:0 0 20px #7cf3d13d}
.caption-burst{position:absolute;left:var(--bx);top:var(--by);font:500 var(--bs) / 1.1 "Cambria Math",Georgia,serif;color:#ddfff7;text-shadow:0 0 12px #75efd05c;white-space:nowrap;opacity:0;will-change:transform,opacity,filter;pointer-events:none}
.caption-halo{position:absolute;inset:-16px;border-radius:12px;background:radial-gradient(circle at 50% 50%,#8df7dc42 0,#8df7dc16 36%,transparent 72%);filter:blur(20px);opacity:.30;animation:halo-breathe 7s ease-in-out infinite alternate;will-change:transform,opacity}
@keyframes halo-breathe{0%{transform:scale(.94) translateY(3px);opacity:.22}100%{transform:scale(1.05) translateY(-3px);opacity:.42}}
.caption-surface{position:relative;min-height:124px;padding:17px 18px;border:1px solid #ffffff52;border-radius:7px;background:linear-gradient(180deg,#fffffff7,#f7fffbe8 62%,#effbf5d3);color:#101419;box-shadow:0 16px 38px #00000045,0 0 18px #ffffff14,inset 0 1px 0 #ffffffd0;backdrop-filter:blur(10px) saturate(.9);-webkit-backdrop-filter:blur(10px) saturate(.9);overflow:hidden;isolation:isolate;animation:card-float 9.6s ease-in-out infinite alternate;will-change:transform}
.caption-card.right .caption-surface{--float-r:.2deg}.caption-card.left .caption-surface{--float-r:-.2deg}
@keyframes card-float{0%{transform:translate3d(0,2px,0) rotate(var(--float-r))}100%{transform:translate3d(0,-3px,0) rotate(calc(var(--float-r) * -.55))}}
...
.caption-surface:after{content:'';position:absolute;inset:0;background:radial-gradient(circle at 18% 18%,#ffffff64,transparent 28%),radial-gradient(circle at 82% 88%,#7df1d214,transparent 24%);mix-blend-mode:screen;pointer-events:none}
@keyframes caption-shine{0%,58%{left:-105%;opacity:0}70%{opacity:.55}100%{left:160%;opacity:0}}
.caption-kicker{display:flex;justify-content:space-between;gap:10px;font:700 9px system-ui;letter-spacing:.15em;color:#46545b;margin-bottom:10px;opacity:.82}.caption-text{font:630 clamp(16px,1.45vw,21px)/1.44 system-ui;letter-spacing:-.025em;overflow-wrap:anywhere;white-space:pre-wrap}
...
.caption-card.past .caption-surface{background:linear-gradient(180deg,#4d535bdc,#3f454dd9);color:#ffffff;border-color:#ffffff20;box-shadow:0 16px 36px #00000062}.caption-card.past .caption-kicker{color:#e9eef4;opacity:.72}.caption-card.past .caption-char.shown,.caption-card.past .caption-char.hot,.caption-card.past .caption-char.near1,.caption-card.past .caption-char.near2{color:#ffffff!important;opacity:1!important;text-shadow:none!important;filter:none!important}.caption-card.past .caption-caret{display:none}.caption-card.past .caption-halo{opacity:.06;filter:blur(14px)}

body.caption-paused #caption-stage *{animation-play-state:paused!important}
@media(max-width:600px){.caption-card{width:min(56vw,224px);top:78%}.caption-card.right{right:6vw}.caption-card.left{left:6vw}.caption-surface{min-height:112px;padding:15px 15px;border-radius:7px;background:linear-gradient(180deg,#fffffff5,#f6fffbe1 58%,#eefaf4cd)}.caption-text{font-size:16.5px;line-height:1.45}.caption-kicker{font-size:8.5px;margin-bottom:9px}.caption-math{font-size:calc(var(--s) * .82)}#floating-music-widget{justify-content:center;width:calc(100vw - 24px);gap:6px}#music-status{width:100%;max-width:none;text-align:center;font-size:11px}.return-top{bottom:140px!important}}
@media(max-width:380px){.caption-card{width:min(66vw,235px)}.caption-text{font-size:16px}}
@media(prefers-reduced-motion:reduce){body.caption-playing .layout{animation:none;transform:none}.caption-aurora,.caption-glow,.caption-math,.caption-orbit,.caption-curve path,.caption-dot,.caption-surface,.caption-surface:before,.caption-caret,.caption-light-sweep,.caption-haze{animation:none!important}.caption-card{transform:translateY(-50%)}}
.motion-off body.caption-playing .layout{animation:none;transform:none}.motion-off .caption-aurora,.motion-off .caption-glow,.motion-off .caption-math,.motion-off .caption-orbit,.motion-off .caption-curve path,.motion-off .caption-dot,.motion-off .caption-surface,.motion-off .caption-surface:before,.motion-off .caption-light-sweep,.motion-off .caption-haze{animation:none!important}
...
stage.innerHTML = `
  ...
  <div class="caption-haze"></div><div class="caption-light-sweep"></div>
...
for(let i=0;i<18;i++){
  ...
  const depth=i%3, x=5 + (i*11)%88, s=(depth===0?12:depth===1?14:16)+(i%4)*.8;
  const d=(depth===0?31:depth===1?26:22)+(i%5)*2.8, delay=(i*1.85)%21, drift=(i%2?'-18px':'18px');
  const alpha=depth===0?.05:depth===1?.085:.13, blur=depth===0?'1.1px':depth===1?'.45px':'.05px', scale=depth===0?.82:depth===1?.9:.98;
  el.style.cssText=`--x:${x}%;--s:${s}px;--d:${d}s;--delay:-${delay}s;--r:${i%2?'-2deg':'2deg'};--drift:${drift};--alpha:${alpha};--blur:${blur};--scale:${scale}`;
  stage.append(el);
}
for(let i=0;i<16;i++){
...
function cuePulse(right){
  if(!moving())return;
  const glow=stage.querySelector('.caption-glow');
  glow?.animate([
    {opacity:.42,transform:'translate(-50%,-50%) scale(.96)'},
    {opacity:.92,offset:.42,transform:'translate(-50%,-50%) scale(1.11)'},
    {opacity:.55,transform:'translate(-50%,-50%) scale(1.02)'}
  ],{duration:1500,easing:'cubic-bezier(.18,.72,.22,1)'});
  const aurora=stage.querySelector(right?'.caption-aurora.b':'.caption-aurora.a');
  aurora?.animate([{opacity:.14},{opacity:.32,offset:.38},{opacity:.18}],{duration:1700,easing:'ease-out'});
}
function mathBurst(i,right){
  if(!moving())return;
  const baseX=right?74:26, baseY=48;
  const pick=['∇f','∂f','dz','∫','Δ','λ'];
  for(let k=0;k<5;k++){
    const el=document.createElement('span'); el.className='caption-burst'; el.textContent=pick[(i+k)%pick.length];
    const bx=baseX+(k-2)*2.2, by=baseY+(k%2?2:-2), dir=right?-1:1;
    el.style.cssText=`--bx:${bx}%;--by:${by}%;--bs:${12+(k%3)*2}px`;
    stage.append(el);
    const dx=dir*(16+k*7)+(k-2)*5, dy=-(52+k*13);
    const a=el.animate([
      {opacity:0,transform:'translate3d(0,12px,0) scale(.75)',filter:'blur(3px)'},
      {opacity:.55,offset:.22,filter:'blur(.4px)'},
      {opacity:.3,offset:.66,transform:`translate3d(${dx*.55}px,${dy*.55}px,0) rotate(${dir*(k-2)*4}deg) scale(1)`},
      {opacity:0,transform:`translate3d(${dx}px,${dy}px,0) rotate(${dir*(k-2)*8}deg) scale(1.08)`,filter:'blur(2px)'}
    ],{duration:2200+k*90,delay:k*55,easing:'cubic-bezier(.18,.72,.22,1)',fill:'forwards'});
    a.onfinish=()=>el.remove();
  }
}
function addRipple(card){
  if(!moving())return;
  const r=document.createElement('span'); r.className='caption-ripple'; card.append(r);
  const a=r.animate([
    {opacity:0,transform:'translate(-50%,-50%) scale(.35)'},
    {opacity:.42,offset:.22},
    {opacity:0,transform:'translate(-50%,-50%) scale(5.8)'}
  ],{duration:1700,easing:'cubic-bezier(.18,.72,.22,1)',fill:'forwards'});
  a.onfinish=()=>r.remove();
}
...
function change(i,animate=true){
  ...
  if(current){
    ...
    if(animate&&moving()){
      const drift = old.classList.contains('right') ? 10 : -10;
      const a=old.animate([
        {opacity:1,transform:'translate3d(0,-50%,0) scale(1)',filter:'blur(0px)'},
        {opacity:.86,offset:.16,transform:`translate3d(${drift*.25}px,calc(-50% - 22px),0) scale(.996)`,filter:'blur(.25px)'},
        {opacity:.48,offset:.46,transform:`translate3d(${drift*.8}px,calc(-50% - 88px),0) scale(.985)`,filter:'blur(1.6px)'},
        {opacity:0,transform:`translate3d(${drift*1.15}px,calc(-50% - 188px),0) scale(.965)`,filter:'blur(8px)'}
      ],{duration:1080,easing:'cubic-bezier(.18,.78,.18,1)',fill:'forwards'});
  ...
  cuePulse(right);mathBurst(i,right);addRipple(card);
  ...
  if(animate&&moving())card.animate([
    {opacity:0,transform:'translate3d(0,calc(-50% + 34px),0) scale(.972)',filter:'blur(8px) saturate(.88)'},
    {opacity:.58,offset:.34,transform:'translate3d(0,calc(-50% + 16px),0) scale(.986)',filter:'blur(3px)'},
    {opacity:.9,offset:.72,transform:'translate3d(0,calc(-50% + 4px),0) scale(1)',filter:'blur(.6px)'},
    {opacity:1,transform:'translate3d(0,-50%,0) scale(1)',filter:'blur(0) saturate(1)'}
  ],{duration:1260,easing:'cubic-bezier(.18,.82,.22,1)'});
}
...
function render(t){
  ...
  if(current&&i>=0){
    ...
    const driftP = p*p*(3-2*p);
    const topPos = 78 - 58*driftP;
    current.style.top = `${topPos}%`;
